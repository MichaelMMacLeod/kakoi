...
fn position_zoomed_small_circle_n(
    ...
    if enclosed_circles % 2 == 1 {
        position_zoomed_small_odd_circle_n(n, angle, enclosing_radius, radius, center, focus_angle)
    } else {
        position_zoomed_small_even_circle_n(n, angle, enclosing_radius, radius, center, focus_angle)
    }
}
